...
import os #to select  music from computer files
import pickle #??
import tkinter as tk #graphical phase neede
...
class player(tk.Frame) :
    ...
    def create_frames(self) : 
        self.track=tk.LabelFrame (self,text="Song Track" ,
                   ...
                   bg="black",fg="crimson",relief=tk.GROOVE ) 
        ...
        self.tracklist.grid(row=0,column=3 ,rowspan=5,pady=7) 

        self.controls=tk.LabelFrame (self,
                 font=('time new roman',17,'bold'),
                   bg="crimson",fg="crimson",relief=tk.GROOVE ) 
        self.controls.configure(width=410,height=80)  
        self.controls.grid(row=4,column=0,pady=7,padx=12) 
    ...
    def track_widgets(self) : 
        ...
        self.songtrack= tk.Label(self.track,font=('time new roman',14,'bold' ),
                    bg="black" ,fg='crimson') 
        self.songtrack['text'] = 'JUDY Music Player'
    ...
    def control_widgets(self):
        self.loadSongs=tk.Button(self.controls , bg='grey' , fg='black' ,font=10)
    ...
    def retrieve_songs(self) : 
        ...
        self.tracklist['text'] =f' playlist - {str(len(self.playlsit))}'
...
root.wm_title('JUDY Music Player')
